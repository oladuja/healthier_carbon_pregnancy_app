...
import 'package:healthier_carbon_pregnancy_app/views/video/helper/cloud.dart';
...
import 'package:healthier_carbon_pregnancy_app/views/video/widgets/common/app_bar/hls_indicator.dart';
import 'package:healthier_carbon_pregnancy_app/views/video/widgets/speaker/participant_list/participant_list.dart';
              ...
              TouchRippleEffect(
                  ...
                  onTap: () async {
                    if (hlsState == "HLS_STOPPING") {
                      ...
                      await deleteId(widget.meeting.id);
                      ...
                      await sendIdToFirebase(widget.meeting.id);
